...
if($_GET['act']=='edit_data_ku'){
                    ...
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <div class="alert bg-pink alert-dismissible" role="alert">
                                ...
                                <h3>SISA DANA BOS TRIWULAN : Rp. <?php echo number_format((double)"$rs_reali_2[dana_bos_digunakan]", 0, ",", ".")?></h3>
                            </div>
                        ...
                        <div class="body">
                                    ...
                                    <input type="hidden" name="id_semester" value="<?php echo $rs_wulan_2["id_semester"] ?>"/>
                                    <input type="hidden" name="id_tapel" value="<?php echo $rs_wulan_2["id_tapel"] ?>"/>
    ...
    <script>
		function print_sptjm_1(){
			window.open("../../modules/cetak/cetak_sptjm_tw_2.php?idu=<?php echo $uidi?>&id_sp=<?php echo"$rs[id_sp]";?>&id_tapel=<?php echo"$rs_wulan_2[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_2[id_semester]";?>","_blank");
		}
	</script>
