...
while($rs=mysql_fetch_array($sql)){
    ...
    $sqlw=mysql_query("select * from tb_realisasi where idu='$uidi' and id_tapel='$_GET[id_tapel]' and id_semester='1'");
    $rkas_lalu=mysql_fetch_array($sqlw);
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <h4>DANA BOS DITERIMA ( <?php echo"$semester[semester]";?> ) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Rp. <?php echo number_format((double)"$rkas_lalu[dana_bos_digunakan]", 0, ",", ".")?><br></br>
                                </h4>
                            </div>
...
?>
                                        ...
                                        ?>
                                        <a href="../../modules/act_simpan_penggunaan_sma.php?act=hapus_pagu_triwulan&id_rkas=<?php echo $rs['id_rkas'] ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">
...
?>
                    ...
                    <div class="modal-content">
                        ...
                        <?php 
                            ...
                            $rsbos=mysql_fetch_array($sql);{
                                ...
                                $sql=mysql_query("select * from tb_realisasi where idu='$uidi' and id_tapel='$_GET[id_tapel]' and id_semester='1'");
                                $rs_realisasi=mysql_fetch_array($sql);
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_sma.php?act=tambah_pagu" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-group-lg">
                                        <div class="form-line">
                                            <input type="text" name="dana_bos_triwulan" id="dana_bos_triwulan" id="num" class="form-control" onkeyup="sum_penggunaan_bos(); sum_penggunaan_bos2(); document.getElementById('format').innerHTML = formatCurrency(this.value);" onkeypress="return hanyaAngka(event)"  placeholder="Pagu Anggaran Dana BOS" />
                                            <span id="format"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    ...
                                    <label>Dana Sisa Lalu</label>
                                            <div class="form-line">
                                            <label>Rp. &nbsp;&nbsp;&nbsp;&nbsp;<input style="color: black; font-family: Verdana,Arial,Helvetica,Georgia; font-size: 17px;" type="text"  name= "dana_bos_triwulan_lalu" value="<?php echo "$rs_realisasi[dana_bos_digunakan]"?>" readonly></label>
                                            </div>
                                    </div>
                                </div>
    ...
    function sum_penggunaan_bos() {
      ...
      var snp_2 = <?php echo "$reali[total]";?>;
      var snp_3 = <?php echo "$reali[dana_bos_digunakan]";?>;
      var dana_sisa_lalu = <?php echo "$reali[dana_bos_digunakan]";?>;
      var result = parseInt(snp_1) - parseInt(pagu) - parseInt(snp_2) + parseInt(snp_3) - parseInt(dana_sisa_lalu);
      if (!isNaN(result)) {
