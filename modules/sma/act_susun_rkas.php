...
?>
                                        ...
                                        ?>
                                        <a href="../../modules/act_simpan_penggunaan_sma.php?act=pengesahan_pagu&id_rkas=<?php echo $rs['id_rkas'] ?>" onclick="javascript: return confirm('Anda yakin Anggaran Disahkan ?')">
                                            <button type="button" class="btn bg-purple waves-effect">
                                            <i class="material-icons">lock</i>
                                            <span>PENGESAHAN</span></button></a>
                                        <?php
                                        }
                                        ?>
                                        <?php
                                        ...
                                        ?>
                                        <a href="../../modules/act_simpan_penggunaan_sma.php?act=hapus_pagu&id_rkas=<?php echo $rs['id_rkas'] ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">
...
?>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-group-lg">
                                        <div class="form-line">
                                            <input type="text" name="dana_bos_triwulan" id="dana_bos_triwulan" class="form-control" onkeyup="sum_penggunaan_bos(); sum_penggunaan_bos2();" onkeypress="return hanyaAngka(event)"  placeholder="Pagu Anggaran Dana BOS" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
    ...
    while($rs=mysql_fetch_array($sql)){
        ...
        $rkas_2=mysql_fetch_array($sqlw);
        $sqlw=mysql_query("select * from tb_realisasi where idu='$uidi' and id_tapel='$_GET[id_tapel]' and id_semester='2'");
        ...
        $sqlw=mysql_query("select * from tb_realisasi where idu='$uidi' and id_tapel='$_GET[id_tapel]' and id_semester='3'");
        ...
        $rkas_4=mysql_fetch_array($sqlw);
        $sqlw=mysql_query("select * from tb_realisasi where idu='$uidi' and id_tapel='$_GET[id_tapel]' and id_semester='4'");
