...
?>
                                        ...
                                        ?>
                                        <a href="../../modules/sma/act_realisasi_penggunaan_snp_view.php?act=edit_data&id_g=<?php echo $rs['id_g'] ?>">
             ...
             <div class="modal fade" id="editbelanjabosModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_sma.php?act=ajuan_snp" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="id_semester" value="<?php echo "$_GET[id_semester]"?>"/>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-group-lg">
                                            <input type="hidden" name="snp_11" id="snp_11" class="form-control" onkeyup="convertToRupiah(this);" onkeypress="return hanyaAngka(event)"  value="0" />
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-group-lg">
                                            <input type="hidden" name="snp_12" id="snp_12" class="form-control" onkeyup="convertToRupiah(this);" onkeypress="return hanyaAngka(event)"  value="0" />
                    ...
                    <div class="modal-content">
                        ...
                        <input type="hidden" name="id_semester" value="<?php echo "$_GET[id_semester]"?>"/>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-group-lg">
                                            <input type="hidden" name="snp_11" id="snp_11a" class="form-control" onkeyup="convertToRupiah(this);" onkeypress="return hanyaAngka(event)"  value="0" />
                                        </div>
                                </div>

                                <div class="col-sm-12">
                                    <div class="form-group form-group-lg">
                                            <input type="hidden" name="snp_12" id="snp_12a" class="form-control" onkeyup="convertToRupiah(this);" onkeypress="return hanyaAngka(event)"  value="0" />
                                        </div>
                                </div>
