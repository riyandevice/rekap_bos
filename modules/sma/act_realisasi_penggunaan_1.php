             ...
             <div class="modal fade" id="editbelanjabosModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_sma.php?act=ajuan_belanja" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        ...
                        <?php 
                            ...
                            $rsbos=mysql_fetch_array($sql);{
                                ...
                                $rkas_12=mysql_fetch_array($sql);		
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_sma.php?act=rev_ajuan_belanja" method="post" enctype="multipart/form-data">
                        <div class="alert bg-pink alert-dismissible" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
