    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    TABEL SEMESTER BERJALAN APLIKASI
...
?>                              
                                            ...
                                            <a href="../../modules/simpan.php?act=aktif_semester&id_semester=<?php echo $rs['id_semester'] ?>">
...
?>
                                            <td class="text-center">
                                            <a href="../../modules/simpan.php?act=unaktif_semester&id_semester=<?php echo $rs['id_semester'] ?>">
