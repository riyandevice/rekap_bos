...
?>
                                        ...
                                        ?>
                                        <a href="../../modules/simpan.php?act=pengesahan_pagu&id_rkas=<?php echo $rs['id_rkas'] ?>" onclick="javascript: return confirm('Anda yakin Anggaran Disahkan ?')">
                                        ...
                                        ?>
                                        <a href="../../modules/simpan.php?act=hapus_pagu&id_rkas=<?php echo $rs['id_rkas'] ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">
            ...
            <div class="modal fade" id="belanjaModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        ?>
                        <form action="../../modules/simpan.php?act=tambah_pagu" method="post" enctype="multipart/form-data">
