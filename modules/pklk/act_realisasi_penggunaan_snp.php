                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Penyelenggaraan BKK SMALB, Prakerin atau PKL, dan Pemagangan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
<?php
...
?>
                                        ...
                                        ?>
                                        <a href="../../modules/pklk/act_realisasi_penggunaan_snp_view.php?act=edit_data&id_g=<?php echo $rs['id_g'] ?>">
             ...
             <div class="modal fade" id="editbelanjabosModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_pklk.php?act=ajuan_snp" method="post" enctype="multipart/form-data">
