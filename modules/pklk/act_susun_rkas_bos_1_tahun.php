                        ...
                        <div class="header">
                            ...
                            <div class="alert bg-teal">
                                ...
                                <small><b>Jika ada Perubahan silahkan Hubungi Operator BOS Cabang Dinas</b></small>
                                        ...
                                        ?>
                                        <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_dana_bos&id_bos=<?php echo $rkas['id_bos'] ?>" onclick="javascript: return confirm('Anda yakin Pengesahan ini ?')">
             ...
             <div class="modal fade" id="bosModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_pklk.php?act=tambah_dana_bos" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <?php 
                            ...
                            $rsbos=mysql_fetch_array($sql);{
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_pklk.php?act=edit_tambah_dana_bos" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        ...
                        <?php 
                            ...
                            $rsbos=mysql_fetch_array($sql);{
                                ...
                                $rs=mysql_fetch_array($sql);		
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_pklk.php?act=tambah_belanja_bos_tahun" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id_bos" value="<?php echo "$rsbos[id_bos]"?>"/>
                        <input type="hidden" name="id_tapel" value="<?php echo "$rsbos[id_tapel]"?>"/>
                        <input type="hidden" name="idu" value="<?php echo "$uidi"?>"/>
                            <div class="row clearfix">
                    ...
                    <div class="modal-content">
                        ...
                        <?php 
                            ...
                            $rsbos=mysql_fetch_array($sql);{
                                ...
                                $rs=mysql_fetch_array($sql);		
                        ?>
                        <form action="../../modules/act_simpan_penggunaan_pklk.php?act=ajuan_snp_1_tahun" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="idu" value="<?php echo "$uidi"?>"/>
                        <input type="hidden" name="id_bos" value="<?php echo "$rsbos[id_bos]"?>"/>
                        <input type="hidden" name="id_tapel" value="<?php echo "$rsbos[id_tapel]"?>"/>
                            <div class="row clearfix">
