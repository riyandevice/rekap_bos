...
?>
                                        ...
                                        <td align=center>Rp. <?php echo number_format((double)"$rs_wulan_1[dana_bos_triwulan]", 0, ",", ".")?><br></br>
                                            ...
                                            if($total_sync_1 == 6){
                                            ?>  
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_jadi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_1[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_1[id_semester]";?>">
                                            ...
                                            ?>
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_revisi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_1[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_1[id_semester]";?>">
                                            <button type="button" class="btn bg-red waves-effect m-r-20">REVISI</button></a>
                                            <?php
                                            } else if ($total_sync_1 == 9) {
                                            ?>
                                            <a href="../../modules/pklk/act_tgl_sptjm_tw_1.php?act=edit_data&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_1[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_1[id_semester]";?>&id_sp=<?php echo"$rs_sptjm_1[id_sp]";?>">
                                        ...
                                        <?php
                                            if($total_sync_2 == 6){
                                            ?>  
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_jadi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_2[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_2[id_semester]";?>">
                                            <button type="button" class="btn bg-purple waves-effect m-r-20">DIJINKAN MENGAJUKAN</button></a>
                                            <?php
                                            ...
                                            ?>
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_revisi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_2[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_2[id_semester]";?>">
                                            <button type="button" class="btn bg-red waves-effect m-r-20">REVISI</button></a>
                                            <?php
                                            } else if ($total_sync_2 == 9) {
                                            ?>
                                            <a href="../../modules/pklk/act_tgl_sptjm_tw_2.php?act=edit_data_ku&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_2[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_2[id_semester]";?>&id_sp=<?php echo"$rs_sptjm_2[id_sp]";?>">
                                            <button type="button" class="btn bg-green waves-effect m-r-20">CETAK SPTJM</button></a><br></br>
                                        ...
                                        <?php
                                            if($total_sync_3 == 6){
                                            ?>  
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_jadi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_3[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_3[id_semester]";?>">
                                            <button type="button" class="btn bg-purple waves-effect m-r-20">DIJINKAN MENGAJUKAN</button></a>
                                            <?php
                                            ...
                                            ?>
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_revisi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_3[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_3[id_semester]";?>">
                                            <button type="button" class="btn bg-red waves-effect m-r-20">REVISI</button></a>
                                            <?php
                                            } else if ($total_sync_3 == 9) {
                                            ?>
                                            <a href="../../modules/pklk/act_tgl_sptjm_tw_3.php?act=edit_data_ku&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_3[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_3[id_semester]";?>&id_sp=<?php echo"$rs_sptjm_3[id_sp]";?>">
                                            <button type="button" class="btn bg-green waves-effect m-r-20">CETAK SPTJM</button></a><br></br>
                                        ...
                                        <?php
                                            if($total_sync_4 == 6){
                                            ?>  
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_jadi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_4[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_4[id_semester]";?>">
                                            <button type="button" class="btn bg-purple waves-effect m-r-20">DIJINKAN MENGAJUKAN</button></a>
                                            <?php
                                            ...
                                            ?>
                                            <a href="../../modules/act_simpan_penggunaan_pklk.php?act=pengesahan_revisi&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_4[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_4[id_semester]";?>">
                                            <button type="button" class="btn bg-red waves-effect m-r-20">REVISI</button></a>
                                            <?php
                                            } else if ($total_sync_4 == 9) {
                                            ?>
                                            <a href="../../modules/pklk/act_tgl_sptjm_tw_4.php?act=edit_data_ku&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs_wulan_4[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_4[id_semester]";?>&id_sp=<?php echo"$rs_sptjm_4[id_sp]";?>">
                                            <button type="button" class="btn bg-green waves-effect m-r-20">CETAK SPTJM</button></a><br></br>
...
<script>
    ...
    <script>
		function print_snp_1(){
			window.open("../../modules/cetak/cetak_penggunaan_snp_pklk.php?idu=<?php echo $uidi?>&id_tapel=<?php echo"$rs_wulan_1[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_1[id_semester]";?>","_blank");
		}
	</script>
    <script>
		function print_snp_2(){
			window.open("../../modules/cetak/cetak_penggunaan_snp_pklk.php?idu=<?php echo $uidi?>&id_tapel=<?php echo"$rs_wulan_2[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_2[id_semester]";?>","_blank");
		}
	</script>
    <script>
		function print_snp_3(){
			window.open("../../modules/cetak/cetak_penggunaan_snp_pklk.php?idu=<?php echo $uidi?>&id_tapel=<?php echo"$rs_wulan_3[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_3[id_semester]";?>","_blank");
		}
	</script>
    <script>
		function print_snp_4(){
			window.open("../../modules/cetak/cetak_penggunaan_snp_pklk.php?idu=<?php echo $uidi?>&id_tapel=<?php echo"$rs_wulan_4[id_tapel]";?>&id_semester=<?php echo"$rs_wulan_4[id_semester]";?>","_blank");
		}
	</script>
