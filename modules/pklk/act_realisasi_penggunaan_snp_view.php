...
if($_GET['act']=='edit_data'){
	?>
                        ...
                        <div class="body">
                                    <form method="post" role="form" action="../../modules/act_simpan_penggunaan_pklk.php?act=revisi_ajuan_snp">
                            ...
                            <div class="col-sm-12">
                                ...
                                <!--div class="col-sm-12">
                                    ...
                                    <div class="form-group form-group-lg">
                                        <div class="form-line">
                                            <input type="text" name="snp_11" id="snp_11" class="form-control" onkeyup="convertToRupiah(this);" onkeypress="return hanyaAngka(event)"  value="<?php echo $rs["snp_11"] ?>" />
                                        </div>
                                    </div>
                                </div-->

                                <div class="col-sm-12">
                                    <label>Penyelenggaraan BKK SMALB, Prakerin atau PKL, dan Pemagangan</label>
                                    <div class="form-group form-group-lg">
                                        <div class="form-line">
                                            <input type="text" name="snp_12" id="snp_12" class="form-control" onkeyup="convertToRupiah(this);" onkeypress="return hanyaAngka(event)"  value="<?php echo $rs["snp_12"] ?>" />
                                        </div>
                                    </div>
                                </div>
