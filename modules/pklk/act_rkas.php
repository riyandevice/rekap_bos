...
?>
                                        ...
                                        if($rsbos['status']=="1"){
                                        ?>  
                                        <a href="../../modules/pklk/act_susun_rkas_bos_1_tahun.php?act=edit_data&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs[id_tapel]";?>">
                                        ...
                                        <td>Rp. <?php echo number_format((double)"$rs_wulan_1[dana_bos_triwulan]", 0, ",", ".")?><br></br>
                                            ...
                                            ?>  
                                            <a href="../../modules/pklk/act_susun_rkas_bos_tw_1.php?act=edit_data&id_semester=1&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs[id_tapel]";?>">
                                            <button type="button" class="btn bg-green waves-effect m-r-20">SUDAH DISUSUN</button></a>
                                            <?php
                                        ...
                                        <br></br>
                                            ...
                                            ?>  
                                            <a href="../../modules/pklk/act_susun_rkas_bos_tw_2.php?act=edit_data&id_semester=2&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs[id_tapel]";?>">
                                            <button type="button" class="btn bg-green waves-effect m-r-20">SUDAH DISUSUN</button></a>
                                            <?php
                                        ...
                                        <td>Rp. <?php echo number_format((double)"$rs_wulan_3[dana_bos_triwulan]", 0, ",", ".")?><br></br>
                                            ...
                                            ?>  
                                            <a href="../../modules/pklk/act_susun_rkas_bos_tw_3.php?act=edit_data&id_semester=3&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs[id_tapel]";?>">
                                            <button type="button" class="btn bg-green waves-effect m-r-20">SUDAH DISUSUN</button></a>
                                            <?php
                                        ...
                                        <td>Rp. <?php echo number_format((double)"$rs_wulan_4[dana_bos_triwulan]", 0, ",", ".")?><br></br>
                                            ...
                                            ?>  
                                            <a href="../../modules/pklk/act_susun_rkas_bos_tw_4.php?act=edit_data&id_semester=4&idu=<?php echo"$uidi";?>&id_tapel=<?php echo"$rs[id_tapel]";?>">
                                            <button type="button" class="btn bg-green waves-effect m-r-20">SUDAH DISUSUN</button></a>
                                            <?php
