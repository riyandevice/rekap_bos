...
if($_GET['act']=="tambah_dana_bos"){
    ...
    <script type='text/javascript'>
     ...
     window.setTimeout(function(){ 
      window.location.replace('../modules/pklk/act_susun_rkas_bos_1_tahun.php?act=edit_data&idu=$_POST[idu]&id_tapel=$_POST[id_tapel]');
     } ,2000); 
    </script>";
	}
...
if($_GET['act']=="tambah_belanja_bos_tahun"){
    ...
    if ($total > $rs["dana"]) {
        echo '<script language="javascript">
              ...
              window.location="../modules/pklk/act_susun_rkas_bos_1_tahun.php?act=edit_data&idu=$_POST[idu]&id_tapel=$_POST[id_tapel]";
              </script>';
              exit();
}
...
$sisa_bos_pagu = ($rsbos['dana'] - $total);
    ...
    <script type='text/javascript'>
     ...
     window.setTimeout(function(){ 
      window.location.replace('../modules/pklk/act_susun_rkas_bos_tw_1.php?act=edit_data&id_semester=$_POST[id_semester]&idu=$_POST[idu]&id_tapel=$_POST[id_tapel]');
     } ,2000); 
    </script>";
	}
...
if($_GET['act']=="hapus_pagu_triwulan"){
    ...
    <script type='text/javascript'>
     ...
     window.setTimeout(function(){ 
      window.location.replace('../modules/pklk/act_rkas.php');
     } ,2000); 
    </script>";
	}
...
if($_GET['act']=="tgl_sptjm_akhir"){
    ...
    if ($total > $rs_total['dana_bos_digunakan']) {
            echo '<script language="javascript">
                ...
                window.location="../modules/pklk/act_pengesahan.php";
                </script>';
                exit();
    }
    ...
    <script type='text/javascript'>
     ...
     window.setTimeout(function(){ 
      window.location.replace('../modules/pklk/act_pengesahan.php');
     } ,2000); 
    </script>";
	}
...
if($_GET['act']=="ajuan_belanja"){
    ...
    if ($total > $sisa_bos_gunakan) {
        echo '<script language="javascript">
              alert ("Pagu Belanja melebihi Dana BOS Dianggarkan dalam 1 Tahun!!!");
              window.location="../modules/pklk/act_pilih.php";
              </script>';
              exit();
    }
    ...
    <script type='text/javascript'>
     ...
     window.setTimeout(function(){ 
      window.location.replace('../modules/pklk/act_realisasi_penggunaan_1.php?idu=$_POST[idu]&id_tapel=$_POST[id_tapel]&id_semester=$_POST[id_semester]');
     } ,2000); 
    </script>";
	}
?>
...
if($_GET['act']=="ajuan_snp"){
    ...
    if ($total_snp > $rs["total"] ) {
        echo '<script language="javascript">
              ...
              window.location="../modules/pklk/act_pilih_snp.php";
              </script>';
              exit();
    }
    ...
    <script type='text/javascript'>
     ...
     window.setTimeout(function(){ 
      window.location.replace('../modules/pklk/act_realisasi_penggunaan_snp.php?idu=$_POST[idu]&id_tapel=$_POST[id_tapel]&id_semester=$_POST[id_semester]');
     } ,2000); 
    </script>";
	}
?>
