...
$rs=mysql_fetch_array($sql);{
    ...
    $sanding_dana_bos_all_tw=($rkas_2['dana_bos_triwulan'] + $rkas_3['dana_bos_triwulan']);
    $sanding_dana_belanja_pegawai_bos=($realisasi_2['belanja_pegawai'] + $realisasi_1['belanja_pegawai']);
    $sanding_dana_belanja_barang_bos=($realisasi_2['belanja_barang'] + $realisasi_1['belanja_barang']);
    $sanding_dana_belanja_alat_bos=($realisasi_2['belanja_modal_alat'] + $realisasi_1['belanja_modal_alat']);
    $sanding_dana_belanja_aset_bos=($realisasi_2['belanja_modal_aset'] + $realisasi_1['belanja_modal_aset']);
