	...
	<table border="1" width="100%" style="border-collapse:collapse;" align="center">
                        ...
                        <tr id="rowHover">
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_1[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_2[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_3[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_4[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_5[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_6[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_7[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$r_snp_8[snp_11]", 0, ",", ".")?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align=center><?php echo number_format((double)"$akum_snp_11", 0, ",", ".")?></td>
