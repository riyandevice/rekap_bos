	...
	<table border="1" width="100%" style="border-collapse:collapse;" align="center">
        ...
        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"> <?php echo number_format((double) "$rkas[akum_bos_lalu_ini]", 0, ",", ".")?></td>
                                        <td align="right"> <?php echo number_format((double) "$rkas[sisa_dana_bos_pagu]", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
		...
		<tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_pegawai]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$total_belanja_pegawai", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        ...
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_barang]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$total_belanja_barang", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        <td rowspan="2">3</td>
                                        ...
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_modal_alat]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$total_belanja_alat", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_modal_aset]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$total_belanja_aset", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="right"> <?php echo number_format((double)"$total_anggaran_triwulan", 0, ",", ".")?></td>
                                        <td align="right"> <?php echo number_format((double)"$total_belanja_all", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
