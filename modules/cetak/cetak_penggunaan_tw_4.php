...
$rs=mysql_fetch_array($sql);{
    $sql=mysql_query("select * from tb_realisasi where idu='$_GET[idu]' and id_semester='2' and id_tapel='$_GET[id_tapel]'");
    ...
    $sql=mysql_query("select * from tb_rkas where idu='$_GET[idu]' and id_semester='2' and id_tapel='$_GET[id_tapel]'");
    ...
    $rkas_3=mysql_fetch_array($sql);
    $sql=mysql_query("select * from tb_rkas where idu='$_GET[idu]' and id_semester='3' and id_tapel='$_GET[id_tapel]'");
    $rkas_4=mysql_fetch_array($sql);

    $sql=mysql_query("select * from tb_realisasi where idu='$_GET[idu]' and id_semester='2' and id_tapel='$_GET[id_tapel]'");
    $realisasi_2=mysql_fetch_array($sql);
    $sql=mysql_query("select * from tb_realisasi where idu='$_GET[idu]' and id_semester='1' and id_tapel='$_GET[id_tapel]'");
    $realisasi_1=mysql_fetch_array($sql);
    $sql=mysql_query("select * from tb_realisasi where idu='$_GET[idu]' and id_semester='3' and id_tapel='$_GET[id_tapel]'");
    $realisasi_3=mysql_fetch_array($sql);

    $sanding_dana_bos_all_tw=($rkas_2['dana_bos_triwulan'] + $rkas_3['dana_bos_triwulan'] + $rkas_4['dana_bos_triwulan']);
    $sanding_dana_belanja_pegawai_bos=($realisasi_2['belanja_pegawai'] + $realisasi_1['belanja_pegawai'] + $realisasi_3['belanja_pegawai']);
    $sanding_dana_belanja_barang_bos=($realisasi_2['belanja_barang'] + $realisasi_1['belanja_barang'] + $realisasi_3['belanja_barang']);
    $sanding_dana_belanja_alat_bos=($realisasi_2['belanja_modal_alat'] + $realisasi_1['belanja_modal_alat'] + $realisasi_3['belanja_modal_alat']);
    $sanding_dana_belanja_aset_bos=($realisasi_2['belanja_modal_aset'] + $realisasi_1['belanja_modal_aset'] + $realisasi_3['belanja_modal_aset']);
    $total_sanding_dana_belanja=($sanding_dana_belanja_pegawai_bos + $sanding_dana_belanja_barang_bos + $sanding_dana_belanja_alat_bos + $sanding_dana_belanja_aset_bos);
    $akumulasi_belanja_bos=($sanding_dana_bos_all_tw - $total_sanding_dana_belanja);
    $sanding_1=($sanding_dana_bos_all_tw + $rkas['dana_bos_triwulan']);
    $sanding_3=($sanding_dana_belanja_pegawai_bos + $rs['belanja_pegawai']);
    $sanding_4=($sanding_dana_belanja_barang_bos + $rs['belanja_barang']);
    $sanding_5=($sanding_dana_belanja_alat_bos + $rs['belanja_modal_alat']);
    $sanding_6=($sanding_dana_belanja_aset_bos + $rs['belanja_modal_aset']);
    $sanding_7=($sanding_3 + $sanding_4 + $sanding_5 + $sanding_6);
    $sanding_8=($sanding_1 - $sanding_7);
    ...
    $sanding_2=($r_bos['dana'] - $sanding_1);
    $s_belanja_pegawai=($r_bos['belanja_pegawai'] - $sanding_3);
    $s_belanja_barang=($r_bos['belanja_barang'] - $sanding_4);
    $s_belanja_alat=($r_bos['belanja_modal_alat'] - $sanding_5);
    $s_belanja_aset=($r_bos['belanja_modal_aset'] - $sanding_6);
    $S_total_akum=($s_belanja_pegawai +  $s_belanja_barang + $s_belanja_alat + $s_belanja_aset);
    }
    ...
    $sanding_triwulan_lalu_ini=($sisa_guna_bos_2 + $rkas['dana_bos_triwulan']);
    ...
    $total_sanding_bos_ini=($tambah_guna_bos_tw_1_2 - $total_sanding_belanja);
	...
	<table border="1" width="100%" style="border-collapse:collapse;" align="center">
        ...
        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><?php echo number_format((double)"$sanding_dana_bos_all_tw", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double) "$rkas[dana_bos_triwulan]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double) "$sanding_1", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double) "$sanding_2", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        ...
                                        <td align="right"></td>
                                        <td align="right"></td>
                                        <td align="right"><?php echo number_format((double) "$akumulasi_belanja_bos", 0, ",", ".")?></td>
                                        <td align="right"></td>
                                        <td align="right"></td>
                                    </tr>
                                    <tr>
		...
		<tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><?php echo number_format((double)"$sanding_dana_belanja_pegawai_bos", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_pegawai]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$sanding_3", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$s_belanja_pegawai", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Belanja Barang dan Jasa BOS</td>
                                        <td align="right"><?php echo number_format((double)"$r_bos[belanja_barang]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$sanding_dana_belanja_barang_bos", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_barang]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$sanding_4", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$s_belanja_barang", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        <td rowspan="2">3</td>
                                        <td>Belanja Modal Peralatan dan Mesin</td>
                                        <td align="right"><?php echo number_format((double)"$r_bos[belanja_modal_alat]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$sanding_dana_belanja_alat_bos", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_modal_alat]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$sanding_5", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$s_belanja_alat", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        
                                        <td>Belanja Modal Aset Tetap Lainnya</td>
                                        <td align="right"><?php echo number_format((double)"$r_bos[belanja_modal_aset]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$sanding_dana_belanja_aset_bos", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$rs[belanja_modal_aset]", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$sanding_6", 0, ",", ".")?></td>
                                        <td align="right"><?php echo number_format((double)"$s_belanja_aset", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><strong>TOTAL PENGGUNAAN</strong></td>
                                        <td align="right"> <?php echo number_format((double)"$total_anggaran", 0, ",", ".")?></td>
                                        <td align="right"> <?php echo number_format((double)"$total_sanding_dana_belanja", 0, ",", ".")?></td>
                                        <td align="right"> <?php echo number_format((double)"$total_anggaran_triwulan", 0, ",", ".")?></td>
                                        <td align="right"> <?php echo number_format((double)"$sanding_7", 0, ",", ".")?></td>
                                        <td align="right"> <?php echo number_format((double)"$S_total_akum", 0, ",", ".")?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="right"><?php echo number_format((double)"$sanding_8", 0, ",", ".")?></td>
                                        <td align="right"></td>
                                    </tr>
        </tr>
    </table>
