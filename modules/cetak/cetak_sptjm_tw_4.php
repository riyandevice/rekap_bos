...
$rs=mysql_fetch_array($sql);{
    ...
    $r_tri_2=mysql_fetch_array($sql);
    $sql=mysql_query("select * from tb_rkas where idu='$_GET[idu]' and id_semester='3' and id_tapel='$_GET[id_tapel]'");
    $r_tri_3=mysql_fetch_array($sql);
    $akum_bos_dana_ini=($r_tri_1['akum_bos_lalu_ini'] + $r_tri_2['dana_bos_triwulan'] + $r_tri_3['dana_bos_triwulan'] + $r_tri['dana_bos_triwulan']);

    $sql=mysql_query("select * from tb_realisasi where idu='$_GET[idu]' and id_semester='1' and id_tapel='$_GET[id_tapel]'");
    $rs_reali=mysql_fetch_array($sql);
    $sql=mysql_query("select * from tb_realisasi where idu='$_GET[idu]' and id_semester='2' and id_tapel='$_GET[id_tapel]'");
    $rs_reali_2=mysql_fetch_array($sql);
    $sql=mysql_query("select * from tb_realisasi where idu='$_GET[idu]' and id_semester='3' and id_tapel='$_GET[id_tapel]'");
    $rs_reali_3=mysql_fetch_array($sql);

    $akum_bos_belanja_ini=(($rs['belanja_pegawai'] + $rs['belanja_barang'] + $rs['belanja_modal_alat'] + $rs['belanja_modal_aset']) + ($rs_reali['belanja_pegawai'] + $rs_reali['belanja_barang'] + $rs_reali['belanja_modal_alat'] + $rs_reali['belanja_modal_aset']) + ($rs_reali_2['belanja_pegawai'] + $rs_reali_2['belanja_barang'] + $rs_reali_2['belanja_modal_alat'] + $rs_reali_2['belanja_modal_aset']) + ($rs_reali_3['belanja_pegawai'] + $rs_reali_3['belanja_barang'] + $rs_reali_3['belanja_modal_alat'] + $rs_reali_3['belanja_modal_aset']));
    $akum_belanja_pegawai=($rs['belanja_pegawai'] + $rs_reali['belanja_pegawai'] + $rs_reali_2['belanja_pegawai'] + $rs_reali_3['belanja_pegawai']);
    $akum_belanja_barang=($rs['belanja_barang'] + $rs_reali['belanja_barang'] + $rs_reali_2['belanja_barang'] + $rs_reali_3['belanja_barang']);
    $akum_belanja_modal_alat=($rs['belanja_modal_alat'] + $rs_reali['belanja_modal_alat'] + $rs_reali_2['belanja_modal_alat'] + $rs_reali_3['belanja_modal_alat']);
    $akum_belanja_modal_aset=($rs['belanja_modal_aset'] + $rs_reali['belanja_modal_aset'] + $rs_reali_2['belanja_modal_aset'] + $rs_reali_3['belanja_modal_aset']);
...
?>
    ...
    <b>A. Penerimaan Dana BOS</b>
		...
		<tr>
            ...
            <td></td>
            <td>Rp.</td>
            <td style="text-align: right"><?php echo number_format((double)"$r_tri_2[dana_bos_triwulan]", 0, ",", ".")?></td>
        </tr>
        <tr>
            <td>3).</td>
            ...
            <td></td>
            <td>Rp.</td>
            <td style="text-align: right"><?php echo number_format((double)"$r_tri_3[dana_bos_triwulan]", 0, ",", ".")?></td>
        </tr>
        <tr>
            <td>4).</td>
            ...
            <td></td>
            <td>Rp.</td>
            <td style="text-align: right"><?php echo number_format((double)"$r_tri[dana_bos_triwulan]", 0, ",", ".")?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td>JUMLAH</td>
            <td></td>
            <td >Rp. <?php echo number_format((double)"$akum_bos_dana_ini", 0, ",", ".")?></td>
        </tr>
    </tbody>
	</table>
<br>
<table>
    ...
    <b>B. Pengeluaran Dana BOS</b>
        <tr>
            ...
            <td></td>
            <td>Rp.</td>
            <td style="text-align: right"><?php echo number_format((double)"$akum_belanja_pegawai", 0, ",", ".")?></td>
        </tr>
		<tr>
            <td>2).</td>
            ...
            <td></td>
            <td>Rp.</td>
            <td style="text-align: right"><?php echo number_format((double)"$akum_belanja_barang", 0, ",", ".")?></td>
        </tr>
        <tr>
            <td>3).</td>
            ...
            <td></td>
            <td>Rp.</td>
            <td style="text-align: right"><?php echo number_format((double)"$akum_belanja_modal_alat", 0, ",", ".")?></td>
        </tr>
        <tr>
            <td>4).</td>
            ...
            <td></td>
            <td>Rp.</td>
            <td style="text-align: right"><?php echo number_format((double)"$akum_belanja_modal_aset", 0, ",", ".")?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td>JUMLAH</td>
            <td></td>
            <td >Rp. <?php echo number_format((double)"$akum_bos_belanja_ini", 0, ",", ".")?></td>
        </tr>
    </tbody>
	</table>
    <br>
