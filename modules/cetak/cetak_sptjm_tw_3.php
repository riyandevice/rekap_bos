...
$rs=mysql_fetch_array($sql);{
    ...
    $akum_bos_dana_ini=($r_tri_1['akum_bos_lalu_ini'] + $r_tri_2['dana_bos_triwulan'] + $r_tri['dana_bos_triwulan']);
    ...
    $akum_belanja_pegawai=($rs['belanja_pegawai'] + $rs_reali['belanja_pegawai'] + $rs_reali_2['belanja_pegawai']);
    $akum_belanja_barang=($rs['belanja_barang'] + $rs_reali['belanja_barang'] + $rs_reali_2['belanja_barang']);
    $akum_belanja_modal_alat=($rs['belanja_modal_alat'] + $rs_reali['belanja_modal_alat'] + $rs_reali_2['belanja_modal_alat']);
    $akum_belanja_modal_aset=($rs['belanja_modal_aset'] + $rs_reali['belanja_modal_aset'] + $rs_reali_2['belanja_modal_aset']);
